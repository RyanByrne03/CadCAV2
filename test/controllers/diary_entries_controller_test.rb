...
class DiaryEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary_entry" do
    assert_difference("DiaryEntry.count") do
      post diary_entries_url, params: { diary_entry: { content: @diary_entry.content, date: @diary_entry.date, title: @diary_entry.title } }
    end
  ...
  test "should update diary_entry" do
    patch diary_entry_url(@diary_entry), params: { diary_entry: { content: @diary_entry.content, date: @diary_entry.date, title: @diary_entry.title } }
